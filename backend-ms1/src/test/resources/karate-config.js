function fn() {
    ...
    config.schoolUrl = config.adminUri + 'school/';
    config.staffUrl = config.adminUri + 'staff/';
    config.professorUrl = config.adminUri + 'professor/';
    config.paymentUrl = config.adminUri + 'payment/';
    config.principalUrl = config.adminUri + 'principal/';
