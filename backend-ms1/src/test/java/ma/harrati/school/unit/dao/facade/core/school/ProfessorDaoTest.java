...
@Autowired
    private ProfessorDao underTest;
    ...
    void shouldFindByEmail(){
        ...
        Professor loaded = underTest.findByEmail(email);
    ...
    void shouldFindById(){
        ...
        entity.setId(id);
        underTest.save(entity);
        Professor loaded = underTest.findById(id).orElse(null);
    ...
    void shouldFindAll() {
        // Given
        List<Professor> items = IntStream.rangeClosed(1, 10).mapToObj(i->constructSample(i)).collect(Collectors.toList());

        // Init
        items.forEach(underTest::save);

        // When
        List<Professor> loadedItems = underTest.findAll();
    ...
    @Test
    void shouldSave(){
        Professor given = constructSample(1);
        Professor saved = underTest.save(given);
