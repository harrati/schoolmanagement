package ma.harrati.school.service.impl.admin.student;
...
import ma.harrati.school.dao.specification.core.student.StudentSpecification;
...
import ma.harrati.school.service.facade.admin.student.PaymentAdminService ;
...
public class StudentAdminServiceImpl implements StudentAdminService {
    ...
    public int deleteBySchoolId(Long id){
        return dao.deleteBySchoolId(id);
    }
    public long countBySchoolId(Long id){
        return dao.countBySchoolId(id);
    }
    @Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class, readOnly = false)
    ...
    if(student !=null && student.getId() != null){
        ...
        emptyIfNull(resultPayments.get(0)).forEach(e -> e.setStudent(student));
    ...
    public void findOrSaveAssociatedObject(Student t){
        if( t != null) {
            t.setSchool(schoolService.findOrSave(t.getSchool()));
        }
    }
    ...
    @Autowired
    private SchoolAdminService schoolService ;
