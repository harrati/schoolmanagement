...
import ma.harrati.school.zynerator.security.bean.*;
...
public class SchoolApplication {
    ...
    private static void addPermission(List<ModelPermission> modelPermissions) {
        ...
        modelPermissions.add(new ModelPermission("School"));
        modelPermissions.add(new ModelPermission("Staff"));
        modelPermissions.add(new ModelPermission("Professor"));
        modelPermissions.add(new ModelPermission("Payment"));
        modelPermissions.add(new ModelPermission("Principal"));
