...
// add
    ...
    public async loadSchool(){
        this.schoolService.findAll().subscribe(schools => this.schools = schools, error => console.log(error))
    }
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            //'School': this.criteria.school?.id ? this.criteria.school?.id : environment.emptyForExport ,
