...
@Component({
  selector: 'app-principal-list-admin',
  templateUrl: './principal-list-admin.component.html'
})
export class PrincipalListAdminComponent implements OnInit {

    protected fileName = 'Principal';
    ...
    constructor( private service: PrincipalAdminService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<PrincipalDto>();
    ...
    public async edit(dto: PrincipalDto) {
    ...
    public async view(dto: PrincipalDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: PrincipalDto) {
    ...
    public async duplicate(dto: PrincipalDto) {
    ...
    public exportPdf(dto: PrincipalDto): void {
...
// add
	...
	public initDuplicate(res: PrincipalDto) {
	}
    ...
    get items(): Array<PrincipalDto> {
        return this.service.items;
    }

    set items(value: Array<PrincipalDto>) {
        this.service.items = value;
    }

    get selections(): Array<PrincipalDto> {
        return this.service.selections;
    }

    set selections(value: Array<PrincipalDto>) {
        this.service.selections = value;
    }

    get item(): PrincipalDto {
        return this.service.item;
    }

    set item(value: PrincipalDto) {
    ...
    get criteria(): PrincipalCriteria {
        return this.service.criteria;
    }

    set criteria(value: PrincipalCriteria) {
