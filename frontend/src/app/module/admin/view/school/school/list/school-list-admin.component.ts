...
@Component({
  selector: 'app-school-list-admin',
  templateUrl: './school-list-admin.component.html'
})
export class SchoolListAdminComponent implements OnInit {

    protected fileName = 'School';
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<SchoolDto>();
    ...
    public async edit(dto: SchoolDto) {
    ...
    public async view(dto: SchoolDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: SchoolDto) {
    ...
    public async duplicate(dto: SchoolDto) {
    ...
    public exportPdf(dto: SchoolDto): void {
...
// add
    ...
    public initCol() {
        this.cols = [
            ...
            {field: 'principal?.email', header: 'Principal'},
        ];
    }


    public async loadPrincipal(){
        this.principalService.findAllOptimized().subscribe(principals => this.principals = principals, error => console.log(error))
    }


	public initDuplicate(res: SchoolDto) {
        if (res.staffs != null) {
             res.staffs.forEach(d => { d.school = null; d.id = null; });
        }
        if (res.professors != null) {
             res.professors.forEach(d => { d.school = null; d.id = null; });
        }
        if (res.students != null) {
             res.students.forEach(d => { d.school = null; d.id = null; });
        }
	}
    ...
    public prepareColumnExport(): void {
        this.service.findByCriteria(this.criteria).subscribe(
            ...
            //'Principal': this.criteria.principal?.email ? this.criteria.principal?.email : environment.emptyForExport ,
            }];
			}
    ...
    get selections(): Array<SchoolDto> {
        return this.service.selections;
    }

    set selections(value: Array<SchoolDto>) {
