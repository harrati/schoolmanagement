...
@Component({
  selector: 'app-school-create-admin',
  templateUrl: './school-create-admin.component.html'
})
export class SchoolCreateAdminComponent  implements OnInit {
    ...
    const isPermistted = await this.roleService.isPermitted('Principal', 'add');
    if(isPermistted) {
