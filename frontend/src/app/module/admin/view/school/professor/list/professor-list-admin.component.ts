...
@Component({
  selector: 'app-professor-list-admin',
  templateUrl: './professor-list-admin.component.html'
})
export class ProfessorListAdminComponent implements OnInit {

    protected fileName = 'Professor';
    ...
    constructor( private service: ProfessorAdminService  , @Inject(PLATFORM_ID) private platformId?) {
    ...
    public findPaginatedByCriteria() {
        this.service.findPaginatedByCriteria(this.criteria).subscribe(paginatedItems => {
            ...
            this.selections = new Array<ProfessorDto>();
    ...
    public async edit(dto: ProfessorDto) {
    ...
    public async view(dto: ProfessorDto) {
        this.service.findByIdWithAssociatedList(dto).subscribe(res => {
            this.item = res;
    ...
    public async delete(dto: ProfessorDto) {
    ...
    public async duplicate(dto: ProfessorDto) {
    ...
    public exportPdf(dto: ProfessorDto): void {
...
// add
	...
	public initDuplicate(res: ProfessorDto) {
	}
    ...
    get items(): Array<ProfessorDto> {
        return this.service.items;
    }

    set items(value: Array<ProfessorDto>) {
        this.service.items = value;
    }

    get selections(): Array<ProfessorDto> {
        return this.service.selections;
    }

    set selections(value: Array<ProfessorDto>) {
        this.service.selections = value;
    }

    get item(): ProfessorDto {
        return this.service.item;
    }

    set item(value: ProfessorDto) {
    ...
    get criteria(): ProfessorCriteria {
        return this.service.criteria;
    }

    set criteria(value: ProfessorCriteria) {
